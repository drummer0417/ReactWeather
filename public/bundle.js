...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WeatherText = __webpack_require__(226);
	  ...
	  render: function render() {
	    ...
	    function renderText() {
	      if (isLoading) {
	        ...
	        return React.createElement(WeatherText, { location: location, temp: temp });
	      } else {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        React.createElement('input', { ref: 'location', placeholder: 'Your location', autoFocus: true })
	      ),
	      React.createElement(
	        'div',
	        null,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=8445080f672f5b8f5fa7feb1ee1c7a6a&units=metric';
